...
let sm =
  "<?xml version='1.0'?>\n\
   ...
   <value><string>local device path (required) (e.g. \
   /dev/sda3)</string></value>\n\
   </member>\n\
   <member>\n\
   <name>key</name>\n\
   ...
   <member>\n\
   <name>description</name>\n\
   <value><string>SR plugin which represents disks as VHD files stored on a \
   local EXT3 filesystem, created inside an LVM volume</string></value>\n\
   </member>\n\
   </struct></value>\n\
   </param>\n\
   </params>\n\
